				...
				<div class="trans_media">
					<div class="social_media">
						...
						<ul>
							...
							<li><a href="https://www.linkedin.com/" target="_blank"><figure><img src="<?php bloginfo('template_url');?>/images/icons/linkedIn-icon.png" alt="LinkedIn"/></figure></a></li>
							<li><a href="https://www.instagram.com/" target="_blank"><figure><img src="<?php bloginfo('template_url');?>/images/icons/ig-icon.png" alt="Instagram"/></figure></a></li>
						</ul>
					</div>
					</div>
				</div>
