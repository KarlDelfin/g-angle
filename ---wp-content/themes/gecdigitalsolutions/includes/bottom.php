	...
	<div class="wrapper">
		<div class="btm1_con">
			<div class="btm1_info_con">
				<div class="btm1_infos">
					<h2 class="hdng"><?php the_field('service_heading')?></div></h2>
                    
				</div>
				<div class="btm1_box " >

					<section class="btm1_boxes wow slideInLeft" data-wow-duration="2636ms">
						<figure><img src="<?php bloginfo('template_url');?>/images/icons/education-icon.png" alt="education icon"/></figure>
						<div class="btm1_info"><?php the_field('service_box1')?></div>	
					</section>

					<section class="btm1_boxes wow zoomIn" data-wow-duration="3000ms">
						<figure><img src="<?php bloginfo('template_url');?>/images/icons/business-resource-icon.png" alt="business resources icon"/></figure>
						<div class="btm1_info"><?php the_field('service_box2'); ?></div>
					</section>

					<section class="btm1_boxes wow slideInRight" data-wow-duration="2636ms">
						<figure><img src="<?php bloginfo('template_url');?>/images/icons/more-services-icon.png" alt="more services icon"/></figure>
						<div class="btm1_info"><?php the_field('service_box3')?></div>
					</section>
				</div>
			</div>
		</div>
...
<div id="bottom3">
	<div class="wrapper">
		<div class="btm3_con">
            ...
            <div class="btm3_boxes wow zoomIn" data-wow-duration="2500ms">
                <div class="owl-carousel owl-theme">
                    ...
                    <?php if ($wpb_all_query->have_posts()) : ?>
                        ...
                        <section class="mid2_box1 animated slideInLeft">
                                ...
                                <?php } else { ?>
                                    <figure>
                                        <img src="<?php bloginfo("template_url") ?>/images/blog/default.png" alt="main logo" />
                                    </figure>
                                <?php } ?>
